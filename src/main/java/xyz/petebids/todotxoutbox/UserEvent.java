...
public class UserEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1776789093577550808L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserEvent\",\"namespace\":\"xyz.petebids.todotxoutbox\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"firstName\",\"type\":\"string\"},{\"name\":\"lastName\",\"type\":\"string\"}]}");
   ...
   */
  public UserEvent(java.lang.CharSequence id, java.lang.CharSequence email, java.lang.CharSequence firstName, java.lang.CharSequence lastName) {
    this.id = id;
    this.email = email;
   ...
   */
  public static xyz.petebids.todotxoutbox.UserEvent.Builder newBuilder() {
    return new xyz.petebids.todotxoutbox.UserEvent.Builder();
  }
   ...
   * @return A new UserEvent RecordBuilder
   */
  public static xyz.petebids.todotxoutbox.UserEvent.Builder newBuilder(xyz.petebids.todotxoutbox.UserEvent.Builder other) {
    if (other == null) {
      return new xyz.petebids.todotxoutbox.UserEvent.Builder();
    } else {
      return new xyz.petebids.todotxoutbox.UserEvent.Builder(other);
    }
  }
   ...
   * @return A new UserEvent RecordBuilder
   */
  public static xyz.petebids.todotxoutbox.UserEvent.Builder newBuilder(xyz.petebids.todotxoutbox.UserEvent other) {
    if (other == null) {
      return new xyz.petebids.todotxoutbox.UserEvent.Builder();
    } else {
      return new xyz.petebids.todotxoutbox.UserEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(xyz.petebids.todotxoutbox.UserEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(xyz.petebids.todotxoutbox.UserEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public xyz.petebids.todotxoutbox.UserEvent.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public xyz.petebids.todotxoutbox.UserEvent.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public xyz.petebids.todotxoutbox.UserEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public xyz.petebids.todotxoutbox.UserEvent.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public xyz.petebids.todotxoutbox.UserEvent.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public xyz.petebids.todotxoutbox.UserEvent.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public xyz.petebids.todotxoutbox.UserEvent.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public xyz.petebids.todotxoutbox.UserEvent.Builder clearLastName() {
      lastName = null;
